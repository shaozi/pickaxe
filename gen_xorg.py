...
def gen_conf():
    ...
    pci_list = []
    GPU_INFO = {
        'Intel': {'driver': 'intel', 'vendorName': 'Intel'},
        'NVIDIA': {'driver': 'nvidia', 'vendorName': 'NVIDIA Corporation'}
    }
...
EndSection
    ...
    xorg_config_file = open('/etc/X11/xorg.conf', 'w')
    xorg_config_file.write(layout_string)
    xorg_config_file.write(config)
